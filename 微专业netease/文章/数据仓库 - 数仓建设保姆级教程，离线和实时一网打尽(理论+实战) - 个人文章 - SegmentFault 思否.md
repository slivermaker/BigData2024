...
![](https://segmentfault.com/img/remote/1460000041586585)
...
![维度建模](https://segmentfault.com/img/remote/1460000039690983 "维度建模")
...
Lambda和Kappa架构的概念已在前文中解释，不了解的小伙伴可点击链接：[一文读懂大数据实时计算](https://link.segmentfault.com/?enc=SjlTHh6cHFCqaxNrcEEw1Q%3D%3D.mZoE9%2F1gB8QTC22VJ2JXP4fJcafLxgGqNGZ%2FfInlCwNiGoKHiFUy1KmQ8thrhsKsZW3GnwX760ZYOruOUCd21w%3D%3D)

下图是基于 Flink 和 Kafka 的 Lambda 架构的具体实践，上层是实时计算，下层是离线计算，横向是按计算引擎来分，纵向是按实时数仓来区分：

![](https://segmentfault.com/img/remote/1460000041586604)
...
![](https://segmentfault.com/img/remote/1460000041586605)
...
![](https://segmentfault.com/img/remote/1460000041586606)
...
![](https://segmentfault.com/img/remote/1460000041586607)
...
![](https://segmentfault.com/img/remote/1460000041586608)
...
![](https://segmentfault.com/img/remote/1460000041586609)

**查看ADS层的ads\_province\_index表数据**:

![](https://segmentfault.com/img/remote/1460000041586610)
...
![](https://segmentfault.com/img/remote/1460000041586611)

**查看ADS层的ads\_sku\_index表数据**：

![](https://segmentfault.com/img/remote/1460000041586612)

### 5\. FineBI展示

![](https://segmentfault.com/img/remote/1460000041586613)

## 七、数据治理

**数仓建设真正的难点不在于数仓设计，而在于后续业务发展起来，业务线变的庞大之后的数据治理**，包括资产治理、数据质量监控、数据指标体系的建设等。

其实数据治理的范围很⼴，包含数据本⾝的管理、数据安全、数据质量、数据成本等。在_DAMA 数据管理知识体系指南_中，数据治理位于数据管理“车轮图”的正中央，是数据架构、数据建模、数据存储、数据安全、数据质量、元数据管理、主数据管理等10大数据管理领域的总纲，为各项数据管理活动提供总体指导策略。

![](https://segmentfault.com/img/remote/1460000041586614)
...
![统一的表命名规范](https://segmentfault.com/img/remote/1460000041586615 "统一的表命名规范")
...
![](https://segmentfault.com/img/remote/1460000041586616)

2.  业务修饰词，用于描述业务场景的词汇，例如trade-交易。

3.日期修饰词，用于修饰业务发生的时间区间。

![](https://segmentfault.com/img/remote/1460000041586617)

4.聚合修饰词，对结果进行聚集操作。

![](https://segmentfault.com/img/remote/1460000041586618)
...
![](https://segmentfault.com/img/remote/1460000041586619)
...
![](https://segmentfault.com/img/remote/1460000041586620)
...
元数据不仅定义了数据仓库中数据的模式、来源、抽取和转换规则等，而且是整个数据仓库系统运行的基础，_元数据把数据仓库系统中各个松散的组件联系起来，组成了一个有机的整体_。
...
![](https://segmentfault.com/img/remote/1460000041586621)
...
1.  [美团数据平台及数仓建设实践，超十万字总结](https://link.segmentfault.com/?enc=IuSHVVNGNS1N4cX14N5FHA%3D%3D.VnsuiwONMcs9%2FfX%2F4YcvULtK3juHZH9lkbiZqfSopbpa0ZM5HQ70LcHfzpkFzqzjPCE06X%2BVo%2FEj3j3xO7S4yg%3D%3D)
2.  [上百本优质大数据书籍，附必读清单(大数据宝藏)](https://link.segmentfault.com/?enc=zxLumA4b46Hi1J3xs2m4ug%3D%3D.CRddZAvbSvTVqeu%2FMkQz10vaexHaPubD5MM5To27ddtRqIfUdSOUSn6Xf5neGmxhVxKnC92LjsHJg8pzHYZv%2FA%3D%3D)
3.  [五万字 | 耗时一个月整理出这份Hadoop吐血宝典](https://link.segmentfault.com/?enc=2qaFCzLCmtkgSc5RQNzoYw%3D%3D.p6R2nlsgCC7pbidQ5qpoN1jETqhLAMtxcPQr%2FHJtvROUa7Jf0gU85iLS6F7eTdRdX5%2BnGbW7DJbHZuFX%2FXfTNg%3D%3D)
...
![](https://segmentfault.com/img/remote/1460000041586622)
...
![](https://segmentfault.com/img/remote/1460000041586623)
...
![](https://segmentfault.com/img/remote/1460000041586624)
...
![](https://segmentfault.com/img/remote/1460000041586625)
...
![](https://segmentfault.com/img/remote/1460000041586626)
...
由于业务系统复杂多变，若日常发布变更频繁，那么每次都通知数据部门，会造成不必要的资源浪费。这时，我们可以使用_之前已经完成标记的数据资产等级标签_，针对涉及高等级数据应用的数据资产，整理出哪些类型的业务变更会影响数据的加工或者影响数据统计口径的调整，则这些情况都必须及时通知到数据部门。

如果公司没有自己的业务发布平台，那么就需要与业务部门约定好，\_针对高等级的数据资产的业务变更，需要以邮件或者其他书面的说明及时反馈到数据部门\_。

**2\. 操作人员管理**：

工具只是辅助监管的一种手段，而使用工具的人员才是核心。数据资产等级的上下游打通过程需要通知给在线业务系统开发人员，使其知道哪些是重要的核心数据资产，哪些暂时还只是作为内部分析数据使用，提高在线开发人员的数据风险意识。

可以通过培训的方式，\_把数据质量管理的诉求，数据质量管理的整个数据加工过程，以及数据产品的应用方式及应用场景告知在线开发人员，使其了解数据的重要性、价值及风险\_。确保在线开发人员在完成业务目标的同时，也要考虑数据的目标，保持业务端和数据段一致。
...
-   \_代码规范类规则\_：如表命名规范、字段命名规范、生命周期设置、表注释等；
-   \_代码质量类规则\_：如分母为 0 提醒、NUll 值参与计算提醒等；
-   \_代码性能类规则\_：如大表提醒、重复计算监测、大小表 join 操作提醒等。
...
风险点监控主要是针对数据在日常运行过程中容易出现的风险进行监控并设置报警机制，主要包括_在线数据_和_离线数据_运行风险点监控。
...
随着业务负责程度的提升，会导致规则繁多、规则配置的运行成本增大，这时可以_按照我们之前的数据资产等级有针对性的进行监控_。
...
![](https://segmentfault.com/img/remote/1460000041586627)
...
DQC 检查其实也是运行 SQL 任务，只是这个任务是嵌套在主任务中的，一旦检查点太多自然就会影响整体的性能，因此还是_依赖数据产等级_来确定规则的配置情况。比如 L1、L2 类数据监控率要达到 90% 以上，规则类型需要三种及以上，而不重要的数据资产则不强制要求。
...
因此，在优先级的设置上，要先确定业务的资产等级，_等级越高的业务对应的消费节点优先级越高_，优先调度并占用计算资源，确保高等级业务的准时产出。
...
![](https://segmentfault.com/img/remote/1460000041586628)
...
![](https://segmentfault.com/img/remote/1460000041586629)
...
![](https://segmentfault.com/img/remote/1460000041586630)
...
1.  [上百本优质大数据书籍，附必读清单(大数据宝藏)](https://link.segmentfault.com/?enc=%2BhsTnKzoPd%2BPLwoEBtrKvQ%3D%3D.rsA88HsdHWgfAnKpsmXE8iNnggs%2BuDw6Okn03b3YkkqhVxBi%2BnvyOBkJkBJnQgfxVOUuV6n8oVaShZwNBoqGsg%3D%3D)
2.  [最强最全面的数仓建设规范指南](https://link.segmentfault.com/?enc=b4%2B4V0ceNfCn5OhcoMY1CQ%3D%3D.TGOKZ1TgsQE5rrKua7PBog3HAJcgzpg6iyxJXZ4%2B7VElFkqk2oZvGQVlYL5QQAEWx06hyz%2Bfn6hVlvBR3vifpTmr3b2LrhQvJb6Nk78GBLQobNPcks5ezs8CMaE39G%2BUrRSHpZ4mddiAmR7AbNXOZaI4smcmqiJhJK3oVoD5BkfD3jGgPD6N%2FGlJNDxVkDhOxuwqPvTT9IGzj09bFOyUsAqhcEoESTaP4yeY0knsAhO5LE4Q3hoDoWZ7EPS8FEnZ)
3.  [美团数据平台及数仓建设实践，超十万字总结](https://link.segmentfault.com/?enc=39hcL%2BLjaPqp4ilshX9KyQ%3D%3D.2gTzw8%2FllTJ%2FUEqWj1nT0hVpmlLqZn1gsiYtdquDEVNUQwRzrAPipV9BRijmzRQQk%2FpoZGtyHJHsCNNUBuRp8w%3D%3D)
4.  [五万字 | 耗时一个月整理出这份Hadoop吐血宝典](https://link.segmentfault.com/?enc=uuZ7WH9CqlNS%2Fb45J84Vjw%3D%3D.FBmODSta1AhZfcxNB%2F0wugBhxOcGKqpYiIpYc1itpDXdGMH%2BGTPxCWoZJSZVtXDlDK0Yf4GhYMXvwCF3LiXTww%3D%3D)